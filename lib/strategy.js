...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.queryStringParameters && req.queryStringParameters.error) {
    if (req.queryStringParameters.error == 'access_denied') {
      return this.fail({ message: req.queryStringParameters.error_description });
    } else {
      return this.error(new AuthorizationError(req.queryStringParameters.error_description, req.queryStringParameters.error, req.queryStringParameters.error_uri));
    }
  }
  ...
  if (req.queryStringParameters && req.queryStringParameters.code) {
    function loaded(err, ok, state) {
      ...
      var code = req.queryStringParameters.code;
    ...
    var state = req.queryStringParameters.state;
    try {
